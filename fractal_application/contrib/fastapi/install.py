...
from fractal_core import DomainException, Settings
from starlette.requests import Request
from starlette.responses import JSONResponse

from fractal_application.contrib.fastapi.exceptions.error_message import ErrorMessage
    ...
    if sentry:
        if sentry_dsn := getattr(settings, "SENTRY_DSN", ""):
            sentry_sdk.init(
                ...
                # Secure by default: don't forward PII (user IPs, request
                # headers/cookies) to Sentry unless a deployment opts in. Was
                # hardcoded True, which sent PII whenever SENTRY_DSN was set.
